...
var $ = function(id){
 ...
 function ext_total(fmobj){
 	...
 	document.getElementById("sum").style.filter="blur(10px)";

 }
 
 function chanage_type_mm(){
	 if($("dengeben2").checked)
		 $("type1_mm1").innerHTML = '<span>月均金额：</span><textarea name="month_money1" rows="5" ></textarea>';
	 else
		 $("type1_mm1").innerHTML = '<span>月均还款：</span><input name="month_money1" type="text" class="guestbook02" />元';
 }
